...
class Vaihingen(SRData):
    ...
    def _scan(self):
        if(self.train):
            names_lr = sorted(
                glob.glob(os.path.join(self.dir_lr, '*' + '.png')) #NIRRG 伪
            )
            names_dsm = sorted(
                glob.glob(os.path.join(self.dir_lr_dsm, '*' + '.png')) #DSM NIRRG伪图对应的DSM图
            )
            #names_lr=[]
            names_hr = []
            for f in names_lr:
...
#         self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
#         self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/gt_generated_place') # gt_generated_place gt_generated_place inpainted_gray
...
# real dsm
    def _set_filesystem(self, dir_data):
        ...
        self.dir_lr = os.path.join(self.apath, 'train/inpainted') #'train/inpainted'
        self.dir_lr_gt = os.path.join(self.apath, 'train/gt')
        # self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'train/gt_generated_place_dsm') #data/fakeV_dsm/train/inpainted_gray_dsm
        self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'train/inpainted_gray_dsm') #data/fakeV_dsm/train/inpainted_gray_dsm
        # self.dir_lr_dsm = os.path.join(self.apath, 'train/inpainted') ##
        # /media/lscsc/nas/mading/data/fakeV_dsm/train/gt_geanerated_place
        self.dir_lr_gt_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'train/gt_dsm') #
        # self.dir_lr_gt_dsm = os.path.join(self.apath, 'train/gt') ##
        ...
        self.dir_test_lr = os.path.join(self.apath, 'test/inpainted') #'test/lama'
        # self.dir_test_lr = os.path.join(self.apath, 'test/lama') #'test/lama'
        # self.dir_test_lr = os.path.join(self.apath, 'test/repaint') #'test/lama'
        self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/gt_generated_place_dsm') # inpainted_gray_dsm
        self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/inpainted_gray_dsm') # inpainted_gray_dsm
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/lama_gray_dsm') # inpainted_gray_dsm
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/repaint_gray_dsm') # inpainted_gray_dsm
