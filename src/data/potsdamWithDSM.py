...
# real dsm
    def _set_filesystem(self, dir_data):
        ...
        self.dir_lr_gt = os.path.join(self.apath, 'train/gt')
        # self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'train/gt_generated_place_dsm') #
        self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'train/inpainted_gray_dsm') # gt_generated_place
        ...
        self.dir_test_hr = os.path.join(self.apath, 'test/inpainted_mask')
        self.dir_test_lr = os.path.join(self.apath, 'test/inpainted') #'test/lama'  inpainted  repaint
        ...
        self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/gt_generated_place_dsm') # gt_generated_place
        self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/inpainted_gray_dsm') # gt_generated_place
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/lama_gray_dsm') # inpainted_gray_dsm
        # self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/repaint_gray_dsm') # inpainted_gray_dsm
