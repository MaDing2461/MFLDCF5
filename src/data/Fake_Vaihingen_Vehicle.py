...
class Fake_Vaihingen_Vehicle(SRData):
    ...
    # # Seedream 4.0, 2 pixel larger mask
    # def _set_filesystem(self, dir_data):
    #     super(Fake_Vaihingen_Vehicle, self)._set_filesystem(dir_data)
    #     self.dir_hr = os.path.join(self.apath, 'train/repaint_mask_2pixel_enlargement_toEveryDirection')
    #     self.dir_lr = os.path.join(self.apath, 'train/seedream_inpaint_2pixel_enlargement_toEveryDirection')
    #     self.dir_lr_gt = os.path.join(self.apath, 'train/gt')

    #     self.dir_test_hr = os.path.join(self.apath, 'test/repaint_mask_2pixel_enlargement_toEveryDirection')
    #     self.dir_test_lr = os.path.join(self.apath, 'test/seedream_inpaint_2pixel_enlargement_toEveryDirection')
    #     self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')

    # # Repaint+LaMa+Seedream 4.0, 2 pixel larger mask
    # def _set_filesystem(self, dir_data):
    #     super(Fake_Vaihingen_Vehicle, self)._set_filesystem(dir_data)
    #     self.dir_hr = os.path.join(self.apath, 'train/all_method_mask_2pixel_enlargement_toEveryDirection')
    #     self.dir_lr = os.path.join(self.apath, 'train/all_method_inpaint_2pixel_enlargement_toEveryDirection')
    #     self.dir_lr_gt = os.path.join(self.apath, 'train/gt')

    #     self.dir_test_hr = os.path.join(self.apath, 'test/all_method_mask_2pixel_enlargement_toEveryDirection')
    #     self.dir_test_lr = os.path.join(self.apath, 'test/all_method_inpaint_2pixel_enlargement_toEveryDirection')
    #     self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
        
     # Repaint+LaMa+Seedream 4.0, 2 pixel larger mask
    def _set_filesystem(self, dir_data):
        super(Fake_Vaihingen_Vehicle, self)._set_filesystem(dir_data)
        self.dir_hr = os.path.join(self.apath, 'train/all_method_mask_2pixel_enlargement_toEveryDirection1')
        self.dir_lr = os.path.join(self.apath, 'train/all_method_inpaint_2pixel_enlargement_toEveryDirection')
        self.dir_lr_gt = os.path.join(self.apath, 'train/gt')

        self.dir_test_hr = os.path.join(self.apath, 'test/all_method_mask_2pixel_enlargement_toEveryDirection1')
        self.dir_test_lr = os.path.join(self.apath, 'test/all_method_inpaint_2pixel_enlargement_toEveryDirection')
        self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')       
