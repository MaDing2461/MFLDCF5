...
from .model1.vit_seg_modeling_resnet_skip import ResNetV2
# FuseResNetV2
...
class FLDCF_multiModal_TransUNet(nn.Module): #FLDCF_multiModal_TransUNet
    def __init__(self, args,config, block=Bottleneck, layers=[1, 2, 2, 1], num_classes=2, aux=True, \
        ...
        super(FLDCF_multiModal_TransUNet, self).__init__()
        self.inplanes = 64
        self.aux = aux	
    ...
    def forward(self, x):
        ...
        # return encodedx, encodedy, attn_weights, features, res2, size_conv1
        score1, attn_weights, features = self.transformer(x)
        # return encoded, attn_weights, features
