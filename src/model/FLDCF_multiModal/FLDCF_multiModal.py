...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, in_channels=3):
        ...
        self.patch_embeddings1 = Conv2d(in_channels=3,
                                       out_channels=config.hidden_size,
                                       kernel_size=256,
                                       stride=256)
        self.patch_embeddingsd1 = Conv2d(in_channels=1,
                                       out_channels=config.hidden_size,
                                       kernel_size=256,
                                       stride=256)
        self.position_embeddings1 = nn.Parameter(torch.zeros(1, n_patches, config.hidden_size))
    ...
    # def forward(self, x, y): #20260501 914
    #     # print(x.shape)
    #     # print(y.shape)
    #     # y = y.unsqueeze(1)
    ...
    #     ##############################################################2
    #     x = self.patch_embeddings1(x)
    #     # print(x.shape)
    #     # (B, hidden. n_patches^(1/2), n_patches^(1/2))
    #     y = self.patch_embeddingsd1(y)
    #     # print(y.shape)
    ...
    #     # print(x.shape)
    #     # print(self.position_embeddings1.shape)
    #     embeddingsx = x + self.position_embeddings1
    #     embeddingsx = self.dropout(embeddingsx)
    #     # print(embeddingsx.shape)
    #     embeddingsy = y + self.position_embeddings1
    #     embeddingsy = self.dropout(embeddingsy)
    #     # print(embeddingsy.shape)
    #     res2 = embeddingsx
    #     ##############################################################        
