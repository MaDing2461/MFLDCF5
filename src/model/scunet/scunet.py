    ...
    'seresnext50':
        {
            ...
            'url': '/media/lscsc/nas/mading/fakedetect/src/model/scunet/pretrain/se_resnext50_32x4d-a260b3a4.pth',
        },
    'senet154':
        {
...
class SCSEUnet(SEUnet):
    def __init__(self,args, seg_classes=1, backbone_arch='seresnext50',return_middle_map = False):
