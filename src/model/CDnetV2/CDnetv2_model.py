...
class CDnetV2_MODEL(nn.Module):
    def __init__(self, args, block=Bottleneck, layers=[3, 4, 6, 3], num_classes=2, aux=True):
    ...
    def base_forward(self, x, RDNout):
        ...
        layer1_0 = x
        layer1_0_copy = layer1_0.clone()
        size_layer1_0_copy = layer1_0_copy.size()[2:]
        # print(1, layer1_0.shape)	
		
        x = self.layerx_2(x)  # 1/4
        layer1_0 = self.con_layer1_1(x + layer1_0)  # 256
        size_layer1_0 = layer1_0.size()[2:]
        # print(layer1_0.shape)
        ...
        return layer1_0, res2, res3, res4, res5,  x,  size_layer1_0, size_res2, size_conv1, layer1_0_copy, size_layer1_0_copy
    ...
    def forward(self, x):
        ...
        size = x.size()[2:]
        # print(x.shape)
        layer1_0, res2, res3, res4, res5, layer4,  size_layer1_0, size_res2, size_conv1, layer1_0_copy, size_layer1_0_copy = self.base_forward(x, RDNout)
        ...
        # print(size_res2)
        # print(size_layer1_0)
        # size_layer1_0 = torch.Size([256, 256])
        ...
        res5 = F.interpolate(res5, size, mode='bilinear', align_corners=True)
        # print(res5.shape)
        # print(layer1_0_copy.shape)
        # res5, _, _= self.affm_5(layer1_0_copy, res5, F.interpolate(hffm, size, mode='bilinear', align_corners=True), 2)	
        # def forward(self, feat1, feat2, hffm, num):
